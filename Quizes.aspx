<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Quizes.aspx.cs" Inherits="FinalFYP.Quizes" %>
...
<div class="container">
    <div class="row">
      <div class="col-md-9">
       <h5><i class="fa fa-pencil-square-o"></i> MANAGE QUIZES</h5>
      </div>
    </div>
  </div>
</header>
            ...
            <div class="row  " style="margin-top:3%">
                    ...
                    <div class="card">
                        ...
                        <div id="padding20">
                            <div class="form-group">
                                <asp:TextBox ID="tb_QuizID" runat="server" Visible="False"></asp:TextBox>
                            </div>
             ...
             <!--TABLE AREA-->
                <div class=" col-md-9 " >
                              ...
                              </div>--%> <asp:UpdatePanel ID="UpdatePanel2" runat="server"><ContentTemplate>
                                <asp:GridView ID="GridView_Quiz" runat="server"
                                    ...
                                    OnPageIndexChanging="GridView_Quiz_PageIndexChanging" OnRowDeleting="GridView_Quiz_RowDeleting" OnSelectedIndexChanged="GridView_Quiz_SelectedIndexChanged" >
                                </asp:GridView>
                           </ContentTemplate></asp:UpdatePanel>
