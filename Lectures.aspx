<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Lectures.aspx.cs" Inherits="FinalFYP.Lectures" %>
...
<div class="container">
    <div class="row">
      <div class="col-md-9">
       <h5><i class="fa fa-book"></i> MANAGE LECTURES</h5>
            ...
            <div class="row" style="margin-top:3%">
                    ...
                    <div class="card" >
                        ...
                        <div id="padding20">
                            <div class="form-group">
                                <asp:TextBox ID="tbLectureID" runat="server" Visible="False"></asp:TextBox>
                            </div>
                ...
                <div class=" col-md-9 " >
                     ...
                     <asp:UpdatePanel ID="UpdatePanel2" runat="server"><ContentTemplate>
                                <asp:GridView ID="GridView_Lectures" runat="server"
                                    ...
                                    OnRowDeleting="GridView_Lectures_RowDeleting"
                                    OnSelectedIndexChanged="GridView_Lectures_SelectedIndexChanged">
                                </asp:GridView>
                           </ContentTemplate></asp:UpdatePanel>
